...
class FormatterTest < Minitest::Test
  ...
  describe 'Formatter should be throw exception for' do
    it 'nil number' do
      assert_raises Formatter::PhoneNumber::Exceptions::NilNumber do
        Formatter::PhoneNumber::UK.format(nil)
      end
    end

    it 'empty number' do
      assert_raises Formatter::PhoneNumber::Exceptions::EmptyNumber do
        Formatter::PhoneNumber::UK.format('')
      end
    end

    it 'random string' do
      assert_raises Formatter::PhoneNumber::UK::Exceptions::BadNumber do
